...
export const evenements: Evenement[] = [
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://admin.brigades.fr/cdn/evenements/banquet-village.jpg",
    images: [],
    temoignages: [],
  ...
  },
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://admin.brigades.fr/cdn/evenements/atelier-cuisine.jpg",
    images: [],
    temoignages: [],
  ...
  },
  {
    ...
    notes: null,
    team_id: null,
    photo_url: "https://admin.brigades.fr/cdn/evenements/marche-paysan.jpg",
    images: [],
    temoignages: [],
